    ...
    <div class="container card order-info">
                                    ...
                                    <div class="room-img-wrapper">
                                        <div class="img"
                                                <c:if test="${room.imageType != null}">
                                                    style="background-image: url('${basePath}/static/images/hostelroom/${order.bookOrder.hostelID}/${room.hostelRoomID}.${room.imageType}')"
                                                </c:if>
                                        ></div>
                                    </div>
                                </div>
        ...
        <div class="book-submit">
            <c:if test="${order.bookOrder.memberID == null && order.bookOrder.state == 'UnCheckIn'}">
                <form action="${basePath}/hostel/order/${order.bookOrder.ID}/cancel" method="post" class="inline">
